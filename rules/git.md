...
- Never commit unless explicitly told to, or if a specific instruction asks for it.
...
Use [Conventional Commits](https://www.conventionalcommits.org/) plus these additional types:
...
- Reference tickets at the end, after a blank line: `Part of <ticket-id>` or `Part of <ticket-id-1>, <ticket-id-2>`; when the ticket is an epic, and the commit is about a child ticket, reference the child over the epic
